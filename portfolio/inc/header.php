            ...
            <div id="navigation" class="collapse navbar-collapse flex-column">
                <div class="profile-section pt-3 pt-lg-0">
                    ...
                    <div class="bio mb-3">
                        ...
                        can also provide a link to the about page.<br /><a href="about.html">Find out more about me</a>
                    </div>
                    <!--//bio-->
                ...
                <ul class="navbar-nav flex-column text-start">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="page.php?slug=<?php echo $slug ?>"><i
                                class="fas fa-user fa-fw me-2"></i>About Me</a>
                    </li>
                </ul>
